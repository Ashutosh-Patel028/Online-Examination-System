...
<head>
  ...
  <!-- Bootstrap CSS & JS Preloader & Camera Plugin-->
...
<!-- MAIN DIV containing Navbar and body OPEN -->
<div class="bg">
    ...
    <div class="container-fluid m-1" style="border:solid 3px red;">
      <!--Body container start-->
      <div  class="row" style="border: 2px solid yellow;">
        <div class="col-8" style="border: 2px solid purple;">
      ...
      <div class="bg-danger d-inline-block col-4 h-100 align-center" style="border: 2px solid black;"></div>
      <!-- Body Container Closed -->
    </div>
</div>
<!-- MAIN DIV containing Navbar and body CLOSED -->
